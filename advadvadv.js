...
// using strict viewport units (vw/vh) and fixed positioning to lock proportions.
...
<head>
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        /* ------------------------------------- */
        #iframe-wrapper {
            position: fixed; /* Changed to fixed to lock to viewport */
            top: 0;
            left: 0;
            width: 100vw;
            height: 100vh;
        ...
        #main-frame {
            ...
            display: block; /* Prevents inline bottom gap */
        }
        ...
        .bottom-nav {
            ...
            pointer-events: auto; /* Re-enable clicks for the actual dock */
        }
...
// Write the fully contained, viewport-locked UI
document.open();
